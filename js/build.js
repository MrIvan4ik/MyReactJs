...
var Holder = _react2.default.createClass({
  ...
  render: function render() {
    return _react2.default.createElement(
      ...
      _react2.default.createElement(Items, { title: 'FOOTBALL SHOES', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing, vivamus congue nulla leo, quis imperdiet magna.' }),
      _react2.default.createElement(Items, { active: 'true', title: 'MODERN CLOTHES', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing, vivamus congue nulla leo, quis imperdiet magna.' }),
      _react2.default.createElement(Items, { title: 'BAGS & ACCESSORIES', description: 'Lorem ipsum dolor sit amet, consectetur adipiscing, vivamus congue nulla leo, quis imperdiet magna.' })
    );
  }
});
...
var Items = _react2.default.createClass({
  ...
  render: function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'p',
        { className: 'product-menu-item__description' },
...
var PopProductHolder = _react2.default.createClass({
  displayName: 'PopProductHolder',

  render: function render() {
    return _react2.default.createElement(
      'div',
      { className: 'popular-product-slider_menu' },
      _react2.default.createElement(PopProductItem, { stars: 'true', title: 'Nike Tailwind Loose', price: '36.99', aftert: 'Running Tank Top', text: 'The Nike Tailwind Loose Womens Running Tank Top is made with sweat-wicking fabric to help you stay dry and comfortable on your run.' }),
      _react2.default.createElement(PopProductItem, { title: 'Nike g87', price: '49.99', aftert: 'Training Tank Top', text: 'The Nike Tailwind Loose Womens Running Tank Top is made with sweat-wicking fabric to help you stay dry and comfortable on your run.' }),
      _react2.default.createElement(PopProductItem, { title: 'Nike I-Beam Swoosh', price: '70.00', aftert: 'Sports Top', text: 'The Nike Tailwind Loose Womens Running Tank Top is made with sweat-wicking fabric to help you stay dry and comfortable on your run.' }),
      _react2.default.createElement(PopProductItem, { title: 'Nike LUX', price: '28.49', aftert: 'Running Top', text: 'The Nike Tailwind Loose Womens Running Tank Top is made with sweat-wicking fabric to help you stay dry and comfortable on your run.' }),
      _react2.default.createElement(PopProductItem, { stars: 'true', title: 'Nike Tailwind Loose', price: '36.99', aftert: 'Running Tank Top', text: 'The Nike Tailwind Loose Womens Running Tank Top is made with sweat-wicking fabric to help you stay dry and comfortable on your run.' }),
      _react2.default.createElement(PopProductItem, { title: 'Nike LUX', price: '28.49', aftert: 'Running Top', text: 'The Nike Tailwind Loose Womens Running Tank Top is made with sweat-wicking fabric to help you stay dry and comfortable on your run.' })
    );
  }
});
var PopProductImage = _react2.default.createClass({
  displayName: 'PopProductImage',
...
var PopProductItem = _react2.default.createClass({
  displayName: 'PopProductItem',

  render: function render() {
    return _react2.default.createElement(
      'div',
      { className: 'popular-product-menu-item' },
      _react2.default.createElement(PopProductImage, { stars: this.props.stars }),
      _react2.default.createElement(
        'h4',
        { className: 'popular-product-menu-item__title' },
        this.props.title
      ),
      _react2.default.createElement(
        'h6',
        { className: 'popular-product-menu-item_after-title' },
        this.props.aftert
      ),
      _react2.default.createElement(
        'p',
        { className: 'popular-product-menu-item__description' },
        this.props.text
      ),
      _react2.default.createElement(
        'div',
        { className: 'popular-product-menu-item-make-order' },
        _react2.default.createElement(
          'p',
          { className: 'popular-product-menu-item-make-order__price' },
          this.props.price
        ),
        _react2.default.createElement('div', { className: 'popular-product-menu-item-make-order__img' })
      )
    );
  }
});

_reactDom2.default.render(_react2.default.createElement(PopProductHolder, null), document.getElementById('popular-product'));
